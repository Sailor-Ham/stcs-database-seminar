...
(
    ...
    budget    DECIMAL(12, 2) NOT NULL COMMENT '학과예산',
...
(
    ...
    dept_name     VARCHAR(20)   DEFAULT NULL COMMENT '학과명',
    salary        DECIMAL(8, 2) DEFAULT 0 COMMENT '월급',
...
(
    ...
    dept_name  VARCHAR(20)   DEFAULT NULL COMMENT '학과명',
    tot_cred   DECIMAL(3, 0) DEFAULT 0 COMMENT '총 이수 학점',
...
(
    ...
    dept_name VARCHAR(20)   DEFAULT NULL COMMENT '학과명',
    credits   DECIMAL(2, 0) DEFAULT 0 COMMENT '학점',
...
(
    s_id VARCHAR(5) NOT NULL COMMENT '학생 ID',
    i_id VARCHAR(5) DEFAULT NULL COMMENT '교수 ID',

    PRIMARY KEY pk_advisor (s_id),
    CONSTRAINT fk_advisor_s_id
        FOREIGN KEY (s_id)
            REFERENCES student (student_id)
            ON DELETE CASCADE,
    CONSTRAINT fk_advisor_i_id
        FOREIGN KEY (i_id)
...
(
    ...
    PRIMARY KEY pk_time_slot (time_slot_id, day, start_time)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = DYNAMIC
...
(
    ...
    capacity    DECIMAL(4, 0) DEFAULT 0 COMMENT '수용 인원',
...
(
    ...
    building     VARCHAR(15) DEFAULT NULL COMMENT '건물명',
    room_number  VARCHAR(7)  DEFAULT NULL COMMENT '강의실 번호',
    time_slot_id VARCHAR(4)  DEFAULT NULL COMMENT '수업 교시 ID (논리적 참조)',
...
(
    ...
    semester   VARCHAR(6)    NOT NULL COMMENT '학기',
    year       DECIMAL(4, 0) NOT NULL COMMENT '년도',
    grade      VARCHAR(2) DEFAULT NULL COMMENT '성적',
